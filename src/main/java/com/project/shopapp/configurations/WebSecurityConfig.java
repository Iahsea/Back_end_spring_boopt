...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(requests -> {
                    requests
                            .requestMatchers(
                                    ...
                                    String.format("%s/users/refreshToken",
                                            apiPrefix)
                            ...
                            .requestMatchers(GET,
                                    String.format("%s/products/category/**",
                                            apiPrefix))
                            .permitAll()
                ...
                .csrf(AbstractHttpConfigurer::disable);
        // .cors(cors -> cors.configurationSource(corsConfigurationSource())); // Cấu
        // hình CORS
    ...
    // CorsConfiguration configuration = new CorsConfiguration();
    // configuration.setAllowedOrigins(List.of("http://localhost:3000")); // Domain
    // được phép
